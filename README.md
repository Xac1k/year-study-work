# Совместное планирование траектории полёта нескольких БПЛА в пространстве с ограничениями

### Аннотация
В тактической авиации ставятся задачи, в которых группе дронов необходимо одновременно прибыть в назначенный район для выполнения совместной задачи, например нанесения удара или радиоэлектронного подавления. Маршруты дронов должны минимизировать видимость для радаров, столкновения, расход топлива и обеспечивать управляемость за счёт плавности траекторий, а также избегать ПВО.

Существуют дискретные и непрерывные подходы к решению задачи. В нашей работе исследованы метаэвристические дискретные алгоритмы для планирования траектории в непрерывном пространтсве с ограничениями. Сопоставлена вычислительная сложность алгоритмов. Обоснован выбран CS-GJO алгоритм.  Разработана математическая модель. Практически доказана эффективность CS-GJO алгоритма. Проверена его корректность.
...
5. Схожий подход к решению задачи
   ...
   Ren R., Lv H., Jiang Y. Uav track planning based on Chaotic Golden Jackal Optimization algorithm //Proceedings of the 2nd International Conference on Signal Processing, Computer Networks and Communications. –  2023. – С. 230-234.
  [Ссылка](https://dl.acm.org/doi/abs/10.1145/3654446.3654487)

6. Похожая задача, но в гражданской области(Наблюдение за распределительными сетями)
